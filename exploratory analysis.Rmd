...
for (i in pollutant_variables){
  ...
  labs(title = "Pollutant Concentration vs. Lung Cancer Death Rate(Male)", y = "Lung Cancer Death Rate(per 100,000)") +
...
for (i in pollutant_variables){
  ...
  geom_point() +
  geom_smooth(method = lm, se = FALSE) +
  labs(title = "Pollutant Concentration vs. Lung Cancer Death Rate(Female)", y = "Lung Cancer Death Rate(per 100,000)") +
  theme(plot.title = element_text(hjust = 0.5, face = "bold"))
