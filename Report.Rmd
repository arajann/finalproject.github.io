...
To further analyze the model fit, we conducted a cross validation of the model vs comparison models that contain different subsets of the predictors. To cross validate we created two comparison models. THe first comparison model included
